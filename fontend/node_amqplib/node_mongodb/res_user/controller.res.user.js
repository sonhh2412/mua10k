         ...
         User.update({
            ...
            !err && (
                ControlUser.updateNotifyMess([{ _id: _id }], 'my_wallet', function(result){
                    ...
                    data.type === '+' ? (
                        message_content = 'Quý khách nhận được <'+data.amount+' K> từ 10kMua. Chúc Quý Khách mua sắm vui vẻ.'
                    ) : (
                        message_content = 'Quý khách bị trừ <'+data.amount+' K> bởi 10kMua. Chúc Quý Khách mua sắm vui vẻ.'
                    )
            ...
            _.each(customers, function(customer_id){
                User.update({
                    ...
                    if (index == customers.length) {
                        ...
                        var message_content  = "10kMua gửi bạn thông báo mới. XEM NGAY!";
